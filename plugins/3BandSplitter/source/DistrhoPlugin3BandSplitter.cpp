...
void DistrhoPlugin3BandSplitter::d_initParameter(uint32_t index, DISTRHO::Parameter& parameter)
{
    switch (index)
    {
    case paramLow:
...
void DistrhoPlugin3BandSplitter::d_run(const float** inputs, float** outputs, uint32_t frames, uint32_t, const DISTRHO::MidiEvent*)
{
