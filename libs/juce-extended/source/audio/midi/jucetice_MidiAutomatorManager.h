...
#include "src/containers/juce_Array.h"
#include "src/audio/midi/juce_MidiMessage.h"
#include "src/audio/midi/juce_MidiBuffer.h"

#include "src/gui/components/mouse/juce_MouseEvent.h"
#include "src/gui/components/menus/juce_PopupMenu.h"
...
protected:
    ...
    void handleMidiPopupMenu_callback(int result);
    static void handleMidiPopupMenu_staticCallback (int result, MidiAutomatable* widget);
};
