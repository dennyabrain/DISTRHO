...
#else
    snprintf (paramName, AudioParameterMaxNameLength, "%s", (const char*) newName.toUTF8());
#endif
...
#else
    snprintf (paramLabel, AudioParameterMaxLabelLength, "%s", (const char*) newLabel.toUTF8());
#endif
