...
public:
	...
	MPCAudioFormatReader(InputStream* const sourceStream) :
		AudioFormatReader(sourceStream, "MPC (Musepack) Audio Format"),
		_lastSample(0),
...
//==============================================================================
static const char* const mpc_extensions[] = { ".mpc", 0 };

MPCAudioFormat::MPCAudioFormat()
    : AudioFormat("MPC (Musepack) Audio Format", StringArray(mpc_extensions))
{
}
...
{
	return fileToTest.hasFileExtension("mpc");
}

Array<int> MPCAudioFormat::getPossibleSampleRates()
{
    const int rates[] = { 44100, 48000, 0 };
    return Array <int>(rates);
}

Array<int> MPCAudioFormat::getPossibleBitDepths()
{
...
//==============================================================================
AudioFormatReader* MPCAudioFormat::createReaderFor(InputStream* sourceStream, bool deleteStreamIfOpeningFails)
{
