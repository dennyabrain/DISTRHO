...
ifeq ($(CONFIG),Debug)
  ...
  TARGET := libjuce-opengl_debug.a
 BLDCMD = ar -rcs $(OUTDIR)/$(TARGET) $(OBJECTS) $(TARGET_ARCH)
endif

OBJECTS := \
	$(OBJDIR)/juce_opengl.o \
...
$(OBJDIR)/juce_opengl.o: ../source/modules/juce_opengl/juce_opengl.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"
