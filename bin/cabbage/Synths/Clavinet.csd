...
{
rslider bounds(  5,  8, 55, 55), text("Pick A"), colour(195,126,  0), FontColour(50,50,50), channel("pickA"),   range(0, 1, 0.25, 1, 0.001)
rslider bounds( 55,  8, 55, 55), text("Pick B"), colour(195,126,  0), FontColour(50,50,50), channel("pickB"),   range(0, 1, 0.07, 1, 0.001)
rslider bounds(  5, 68, 55, 55), text("Mod A"),  colour(225,156, 28),  FontColour(50,50,50), channel("ModA"),   range(0,0.5, 0.03, 0.5, 0.001)
rslider bounds( 55, 68, 55, 55), text("Mod B"),  colour(225,156, 28),  FontColour(50,50,50), channel("ModB"),   range(0,0.5, 0.03, 0.5, 0.001)
rslider bounds(  5,128, 55, 55), text("Rate A"), colour(255,186, 58), FontColour(50,50,50), channel("RateA"),   range(0,14, 0.2, 0.5, 0.001)
rslider bounds( 55,128, 55, 55), text("Rate B"), colour(255,186, 58), FontColour(50,50,50), channel("RateB"),   range(0,14, 0.15, 0.5, 0.001)
rslider bounds(  5,188, 55, 55), text("Env.A"),  colour(255,216, 88), FontColour(50,50,50), channel("EnvA"),   range(-1, 1, 0)
rslider bounds( 55,188, 55, 55), text("Env.B"),  colour(255,216, 88), FontColour(50,50,50), channel("EnvB"),   range(-1, 1, 0)
rslider bounds(  5,248, 55, 55), text("Time A"), colour(255,246,118), FontColour(50,50,50), channel("TimeA"),   range(0, 1, 0.05, 0.5, 0.001)
rslider bounds( 55,248, 55, 55), text("Time B"), colour(255,246,118), FontColour(50,50,50), channel("TimeB"),   range(0, 1, 0.05, 0.5, 0.001)
line bounds(110, 25,  1, 260), colour( 50, 50, 50)
rslider bounds(112,  8, 55, 55), text("Pluck"),  colour(195,126,  0), FontColour(50,50,50), channel("plk"),     range(0, 1, 0.005, 0.5, 0.0001)
rslider bounds(112, 68, 55, 55), text("Damp"),   colour(225,156, 28), FontColour(50,50,50), channel("SusDamp"), range(-1, 1, 0)
rslider bounds(112,128, 55, 55), text("HPF"),    colour(255,186, 58), FontColour(50,50,50), channel("HPF"),     range(0,16, 0)
rslider bounds(112,188, 55, 55), text("LPF"),    colour(255,216, 88), FontColour(50,50,50), channel("LPF"),     range(1,72, 72, 0.375, 0.0001)
...
{
rslider bounds(  5,  8, 55, 55), text("Ampl."),  colour(255,186,58), FontColour(50,50,50), channel("RelAmpl"),  range(0, 20, 2)
...
rslider  bounds(  5, 85, 55, 55), channel("gain1"), text("Gain 1"), colour(255,216,88), FontColour(50,50,50),  range(0.5,30,  3,0.5)
rslider  bounds( 60, 85, 55, 55), channel("gain2"), text("Gain 2"), colour(255,216,88), FontColour(50,50,50),  range(0.5,30,2.3,0.5)
rslider  bounds(115, 85, 55, 55), channel("gain3"), text("Gain 3"), colour(255,216,88), FontColour(50,50,50),  range(0.5,30,1.3,0.5)
rslider bounds(170, 85, 55, 55), channel("gain4"),  text("Gain 4"), colour(255,216,88),  FontColour(50,50,50),  range(0.5,30,1.4,0.5)
rslider bounds(  5,140, 55, 55), channel("Q1"),     text("Q 1"),    colour(255,255,138), FontColour(50,50,50),  range(0.5,30,1.25,0.5)
rslider bounds( 60,140, 55, 55), channel("Q2"),     text("Q 2"),    colour(255,255,138), FontColour(50,50,50),  range(0.5,30,1   ,0.5)
rslider bounds(115,140, 55, 55), channel("Q3"),     text("Q 3"),    colour(255,255,138), FontColour(50,50,50),  range(0.5,30,1   ,0.5)
rslider bounds(170,140, 55, 55), channel("Q4"),     text("Q 4"),    colour(255,255,138), FontColour(50,50,50),  range(0.5,30,2   ,0.5)
