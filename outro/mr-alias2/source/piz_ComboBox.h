...
#ifndef __PIZ_COMBOBOX_JUCEHEADER__
#define __PIZ_COMBOBOX_JUCEHEADER__
...
*/
class PizComboBoxListener
{
public:
    /** Destructor. */
    virtual ~PizComboBoxListener() {}
...
/**
    ...
    can register a PizComboBoxListener to receive callbacks.

    @see PizComboBoxListener
*/
class PizComboBox  : public Component,
...
public:
    ...
    */
    PizComboBox (const String& componentName);
    ...
    */
    ...
    void addListener (PizComboBoxListener* const listener) throw();

    /** Deregisters a previously-registered listener. */
    void removeListener (PizComboBoxListener* const listener) throw();
...
private:
    ...
    PizComboBox (const PizComboBox&);
	const bool operator== (ComboBox*);
    const PizComboBox& operator= (const PizComboBox&);
};

#endif   // __PIZ_COMBOBOX_JUCEHEADER__
