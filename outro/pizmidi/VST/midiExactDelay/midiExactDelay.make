...
ifeq ($(CONFIG),Release)
  ...
  OUTDIR := ../../../../bin
  CPPFLAGS := $(DEPFLAGS) -D "LINUX=1" -D "__cdecl=""" -D "NDEBUG=1" -I "../../source/midiExactDelay" -I "../../../../sdks/vstsdk2.4"
  ...
  LDDEPS :=
  RESFLAGS := -D "LINUX=1" -D "__cdecl=""" -D "NDEBUG=1" -I "../../source/midiExactDelay" -I "../../../../sdks/vstsdk2.4"
  TARGET := midiExactDelay.so
...
ifeq ($(CONFIG),Debug)
  ...
  OUTDIR := ../../../../bin
  CPPFLAGS := $(DEPFLAGS) -D "LINUX=1" -D "__cdecl=""" -D "DEBUG=1" -D "_DEBUG=1" -I "../../source/midiExactDelay" -I "../../../../sdks/vstsdk2.4"
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -fPIC -g -O0 -ggdb -fPIC
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -shared
  LDDEPS :=
  RESFLAGS := -D "LINUX=1" -D "__cdecl=""" -D "DEBUG=1" -D "_DEBUG=1" -I "../../source/midiExactDelay" -I "../../../../sdks/vstsdk2.4"
  TARGET := midiExactDelay_debug.so
 BLDCMD = $(CXX) -o $(OUTDIR)/$(TARGET) $(OBJECTS) $(LDFLAGS) $(RESOURCES) $(TARGET_ARCH)
endif

OBJECTS := \
	$(OBJDIR)/midiExactDelay.o \
	$(OBJDIR)/PizMidi.o \
...
$(OBJDIR)/midiExactDelay.o: ../../source/midiExactDelay/midiExactDelay.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"
