...
#ifndef __JUCETICE_NEKOBEECOMPONENT_HEADER__
#define __JUCETICE_NEKOBEECOMPONENT_HEADER__

#include "NekobeePlugin.h"
#include "Components/NekobeeMain.h"
...
*/
class NekobeeComponent  : public AudioProcessorEditor,
...
public:
    ...
    */
    NekobeeComponent (NekobeePlugin* const ownerFilter);
...
private:
    ...
    //==============================================================================
    friend class NekobeePlugin;

    NekobeeMain* mainComponent;

    TooltipWindow tooltipWindow;

    // handy wrapper method to avoid having to cast the filter to a DemoJuceFilter
    // every time we need it..
    NekobeePlugin* getFilter() const throw()  { return (NekobeePlugin*) getAudioProcessor(); }
};
