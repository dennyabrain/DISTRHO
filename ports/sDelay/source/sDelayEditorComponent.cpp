...
sDelayEditorComponent::sDelayEditorComponent (DemoJuceFilter* const ownerFilter)
    : AudioProcessorEditor (ownerFilter),
      ...
      label4 (0)
{
    addAndMakeVisible (slider = new Slider ("delay slider"));
    slider->setRange (0, 3000, 1);
    slider->setSliderStyle (Slider::RotaryVerticalDrag);
    slider->setTextBoxStyle (Slider::TextBoxBelow, false, 40, 20);
    slider->addListener (this);

    addAndMakeVisible (feedSlider = new Slider ("feedback slider"));
    ...
    addAndMakeVisible (label = new Label ("new label",
                                          "sDelay"));
    label->setFont (Font ("DejaVu Sans", 19.1000f, Font::plain));
    ...
    addAndMakeVisible (label2 = new Label ("new label",
                                           "Delay"));
    label2->setFont (Font ("DejaVu Sans", 15.0000f, Font::plain));
    ...
    addAndMakeVisible (label3 = new Label ("new label",
                                           "Feedback"));
    label3->setFont (Font ("DejaVu Sans", 15.0000f, Font::plain));
    ...
    addAndMakeVisible (label4 = new Label ("new label",
                                           "Gain"));
    label4->setFont (Font ("DejaVu Sans", 15.0000f, Font::plain));
