																	...
																	Slider& slider)
{
	...
	Image newSlider = drawRotaryImage(destWidth, sliderColour, Colour::fromString(trackColour), sliderPosProportional, 
																						...
																						Slider &slider)
{
	...
	//thumb fill
	ColourGradient thumbColour = ColourGradient(Colour::fromRGB(30, 30, 30), destX, destY, 
