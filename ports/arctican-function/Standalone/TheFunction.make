...
ifeq ($(CONFIG),Release)
  ...
  OUTDIR := ../../../bin
  CPPFLAGS := $(DEPFLAGS) -D "JucePlugin_Build_AU=0" -D "JucePlugin_Build_LV2=0" -D "JucePlugin_Build_RTAS=0" -D "JucePlugin_Build_VST=0" -D "JucePlugin_Build_Standalone=1" -D "LINUX=1" -D "NDEBUG=1" -I "../source" -I "../../../libs/juce-2.0/source" -I "../../../libs/juce-2.0/plugin"
...
ifeq ($(CONFIG),Debug)
  ...
  OUTDIR := ../../../bin
  CPPFLAGS := $(DEPFLAGS) -D "JucePlugin_Build_AU=0" -D "JucePlugin_Build_LV2=0" -D "JucePlugin_Build_RTAS=0" -D "JucePlugin_Build_VST=0" -D "JucePlugin_Build_Standalone=1" -D "LINUX=1" -D "DEBUG=1" -D "_DEBUG=1" -I "../source" -I "../../../libs/juce-2.0/source" -I "../../../libs/juce-2.0/plugin"
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -g `pkg-config --cflags freetype2` -O0 -ggdb -fPIC
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) `pkg-config --libs freetype2` -L"../../../libs" -lfreetype -lpthread -lasound -ldl -lrt -lX11 -lXext -ljuce-core_debug -ljuce-audio-basics_debug -ljuce-audio-processors_debug -ljuce-data-structures_debug -ljuce-events_debug -ljuce-graphics_debug -ljuce-gui-basics_debug -ljuce-audio-devices_debug -ljuce-audio-formats_debug -ljuce-audio-utils_debug
  LDDEPS :=
