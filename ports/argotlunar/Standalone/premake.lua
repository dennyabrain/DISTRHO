...
package.config["Release"].buildoptions = { "-O2 -ffast-math -fpermissive -fomit-frame-pointer -fvisibility=hidden -mtune=generic -msse -mfpmath=sse" }
...
package.config["Debug"].buildoptions   = { "-O0 -fpermissive -ggdb" }
