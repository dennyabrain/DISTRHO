...
package.config["Release"].buildoptions = { "-fpermissive -O2 -ffast-math -fomit-frame-pointer -fvisibility=hidden -mtune=generic -msse -mfpmath=sse" }
...
package.config["Debug"].buildoptions   = { "-fpermissive -O0 -ggdb" }
