...
#ifndef __JUCER_HEADER_PLUGINEDITOR_PLUGINEDITOR_44654DDA__
#define __JUCER_HEADER_PLUGINEDITOR_PLUGINEDITOR_44654DDA__
...
private:
    ...
    void updateProgramNamesFromFilter();
    Plugin* getFilter() const throw()       {
      return (Plugin*) getAudioProcessor();
    }
    ...
    Label* label36;
    Label* label37;
    ToggleButton* matrixMode1;
    ToggleButton* matrixMode2;
    ToggleButton* matrixMode3;
    TextEditor* scalekey_display;
    ToggleButton* trans_toggle;
...
#endif   // __JUCER_HEADER_PLUGINEDITOR_PLUGINEDITOR_44654DDA__
