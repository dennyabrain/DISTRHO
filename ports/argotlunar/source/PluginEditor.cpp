/*
  ...
  Creation date:  3 Jan 2011 7:36:01pm
      ...
      gliss_toggle (0)
{
    ...
    filtertype_combobox->setTextWhenNoChoicesAvailable (T("(no choices)"));
    filtertype_combobox->addItem (T("off"), 1);
    filtertype_combobox->addItem (T("band"), 2);
    filtertype_combobox->addItem (T("low"), 3);
    filtertype_combobox->addItem (T("high"), 4);
    filtertype_combobox->addItem (T("notch"), 5);
    filtertype_combobox->addItem (T("comb"), 6);
    filtertype_combobox->addItem (T("random"), 7);
    filtertype_combobox->addListener (this);

    addAndMakeVisible (initButton = new TextButton (String::empty));
    initButton->setButtonText (T("Init"));
    initButton->setConnectedEdges (Button::ConnectedOnLeft | Button::ConnectedOnRight | Button::ConnectedOnTop);
    initButton->addButtonListener (this);
    ...
    saveButton->setConnectedEdges (Button::ConnectedOnLeft | Button::ConnectedOnRight | Button::ConnectedOnTop);
    ...
    savetoButton->setButtonText (T("Save To"));
    savetoButton->setConnectedEdges (Button::ConnectedOnLeft | Button::ConnectedOnRight | Button::ConnectedOnTop);
    savetoButton->addButtonListener (this);
    ...
    decPresetButton->setButtonText (T("-"));
    decPresetButton->setConnectedEdges (Button::ConnectedOnLeft | Button::ConnectedOnRight | Button::ConnectedOnTop);
    decPresetButton->addButtonListener (this);
    ...
    incPresetButton->setButtonText (T("+"));
    incPresetButton->setConnectedEdges (Button::ConnectedOnLeft | Button::ConnectedOnRight | Button::ConnectedOnTop);
    incPresetButton->addButtonListener (this);
    ...
    program_combobox->setTextWhenNoChoicesAvailable (T("(no choices)"));
    program_combobox->addListener (this);

    addAndMakeVisible (label25 = new Label (String::empty,
                                            T("argotlunar v2.0.2")));
    label25->setFont (Font (18.0000f, Font::plain));
    ...
    envskew_slider->setRange (0.05, 0.95, 0.001);
    ...
    addAndMakeVisible (freeze_toggle = new ToggleButton (String::empty));
    freeze_toggle->addButtonListener (this);
    freeze_toggle->setColour (ToggleButton::textColourId, Colours::white);
    ...
    scale_combobox->setTextWhenNoChoicesAvailable (T("(no choices)"));
    ...
    matrix_src_combobox_1->setTextWhenNoChoicesAvailable (T("(no choices)"));
    matrix_src_combobox_1->addItem (T("Off"), 1);
    matrix_src_combobox_1->addItem (T("Amp"), 2);
    matrix_src_combobox_1->addItem (T("Pan L/R"), 3);
    matrix_src_combobox_1->addItem (T("Pan Width"), 4);
    matrix_src_combobox_1->addItem (T("Delay"), 5);
    matrix_src_combobox_1->addItem (T("IOT"), 6);
    matrix_src_combobox_1->addItem (T("Dur"), 7);
    matrix_src_combobox_1->addItem (T("Trans"), 8);
    matrix_src_combobox_1->addItem (T("Gliss"), 9);
    matrix_src_combobox_1->addItem (T("FFreq"), 10);
    matrix_src_combobox_1->addItem (T("FQ"), 11);
    ...
    matrix_dest_combobox_1->setTextWhenNoChoicesAvailable (T("(no choices)"));
    matrix_dest_combobox_1->addItem (T("Off"), 1);
    matrix_dest_combobox_1->addItem (T("Amp"), 2);
    matrix_dest_combobox_1->addItem (T("Pan L/R"), 3);
    matrix_dest_combobox_1->addItem (T("Delay"), 4);
    matrix_dest_combobox_1->addItem (T("IOT"), 5);
    matrix_dest_combobox_1->addItem (T("Dur"), 6);
    matrix_dest_combobox_1->addItem (T("Trans"), 7);
    matrix_dest_combobox_1->addItem (T("Gliss"), 8);
    matrix_dest_combobox_1->addItem (T("FFreq"), 9);
    matrix_dest_combobox_1->addItem (T("FQ"), 10);
    matrix_dest_combobox_1->addItem (T("Sustain"), 11);
    matrix_dest_combobox_1->addItem (T("Skew"), 12);
    ...
    matrix_src_combobox_2->setTextWhenNoChoicesAvailable (T("(no choices)"));
    matrix_src_combobox_2->addItem (T("Off"), 1);
    matrix_src_combobox_2->addItem (T("Amp"), 2);
    matrix_src_combobox_2->addItem (T("Pan L/R"), 3);
    matrix_src_combobox_2->addItem (T("Pan Width"), 4);
    matrix_src_combobox_2->addItem (T("Delay"), 5);
    matrix_src_combobox_2->addItem (T("IOT"), 6);
    matrix_src_combobox_2->addItem (T("Dur"), 7);
    matrix_src_combobox_2->addItem (T("Trans"), 8);
    matrix_src_combobox_2->addItem (T("Gliss"), 9);
    matrix_src_combobox_2->addItem (T("FFreq"), 10);
    matrix_src_combobox_2->addItem (T("FQ"), 11);
    ...
    matrix_dest_combobox_2->setTextWhenNoChoicesAvailable (T("(no choices)"));
    matrix_dest_combobox_2->addItem (T("Off"), 1);
    matrix_dest_combobox_2->addItem (T("Amp"), 2);
    matrix_dest_combobox_2->addItem (T("Pan L/R"), 3);
    matrix_dest_combobox_2->addItem (T("Delay"), 4);
    matrix_dest_combobox_2->addItem (T("IOT"), 5);
    matrix_dest_combobox_2->addItem (T("Dur"), 6);
    matrix_dest_combobox_2->addItem (T("Trans"), 7);
    matrix_dest_combobox_2->addItem (T("Gliss"), 8);
    matrix_dest_combobox_2->addItem (T("FFreq"), 9);
    matrix_dest_combobox_2->addItem (T("FQ"), 10);
    matrix_dest_combobox_2->addItem (T("Sustain"), 11);
    matrix_dest_combobox_2->addItem (T("Skew"), 12);
    ...
    matrix_src_combobox_3->setTextWhenNoChoicesAvailable (T("(no choices)"));
    matrix_src_combobox_3->addItem (T("Off"), 1);
    matrix_src_combobox_3->addItem (T("Amp"), 2);
    matrix_src_combobox_3->addItem (T("Pan L/R"), 3);
    matrix_src_combobox_3->addItem (T("Pan Width"), 4);
    matrix_src_combobox_3->addItem (T("Delay"), 5);
    matrix_src_combobox_3->addItem (T("IOT"), 6);
    matrix_src_combobox_3->addItem (T("Dur"), 7);
    matrix_src_combobox_3->addItem (T("Trans"), 8);
    matrix_src_combobox_3->addItem (T("Gliss"), 9);
    matrix_src_combobox_3->addItem (T("FFreq"), 10);
    matrix_src_combobox_3->addItem (T("FQ"), 11);
    ...
    matrix_dest_combobox_3->setTextWhenNoChoicesAvailable (T("(no choices)"));
    matrix_dest_combobox_3->addItem (T("Off"), 1);
    matrix_dest_combobox_3->addItem (T("Amp"), 2);
    matrix_dest_combobox_3->addItem (T("Pan L/R"), 3);
    matrix_dest_combobox_3->addItem (T("Delay"), 4);
    matrix_dest_combobox_3->addItem (T("IOT"), 5);
    matrix_dest_combobox_3->addItem (T("Dur"), 6);
    matrix_dest_combobox_3->addItem (T("Trans"), 7);
    matrix_dest_combobox_3->addItem (T("Gliss"), 8);
    matrix_dest_combobox_3->addItem (T("FFreq"), 9);
    matrix_dest_combobox_3->addItem (T("FQ"), 10);
    matrix_dest_combobox_3->addItem (T("Sustain"), 11);
    matrix_dest_combobox_3->addItem (T("Skew"), 12);
    ...
    addAndMakeVisible (matrixMode1 = new ToggleButton (String::empty));
    matrixMode1->addButtonListener (this);
    matrixMode1->setToggleState (true, false);
    matrixMode1->setColour (ToggleButton::textColourId, Colours::white);

    addAndMakeVisible (matrixMode2 = new ToggleButton (String::empty));
    matrixMode2->addButtonListener (this);
    matrixMode2->setToggleState (true, false);
    matrixMode2->setColour (ToggleButton::textColourId, Colours::white);

    addAndMakeVisible (matrixMode3 = new ToggleButton (String::empty));
    matrixMode3->addButtonListener (this);
    matrixMode3->setToggleState (true, false);
    matrixMode3->setColour (ToggleButton::textColourId, Colours::white);
    ...
    addAndMakeVisible (trans_toggle = new ToggleButton (String::empty));
    trans_toggle->addButtonListener (this);
    trans_toggle->setToggleState (true, false);
    trans_toggle->setColour (ToggleButton::textColourId, Colours::white);
    ...
    envtype_combobox->setTextWhenNoChoicesAvailable (T("(no choices)"));
    envtype_combobox->addItem (T("RCB"), 1);
    envtype_combobox->addItem (T("parabola"), 2);
    envtype_combobox->addItem (T("triangle"), 3);
    ...
    dur_quant_combobox->setTextWhenNoChoicesAvailable (T("(no choices)"));
    dur_quant_combobox->addItem (T("ms"), 1);
    dur_quant_combobox->addItem (T("128"), 2);
    dur_quant_combobox->addItem (T("128T"), 3);
    dur_quant_combobox->addItem (T("64"), 4);
    dur_quant_combobox->addItem (T("64T"), 5);
    dur_quant_combobox->addItem (T("32"), 6);
    dur_quant_combobox->addItem (T("32T"), 7);
    dur_quant_combobox->addItem (T("16"), 8);
    dur_quant_combobox->addItem (T("16T"), 9);
    dur_quant_combobox->addItem (T("8"), 10);
    dur_quant_combobox->addItem (T("8T"), 11);
    dur_quant_combobox->addItem (T("4"), 12);
    dur_quant_combobox->addItem (T("4T"), 13);
    dur_quant_combobox->addItem (T("long"), 14);
    ...
    iot_quant_combobox->setTextWhenNoChoicesAvailable (T("(no choices)"));
    iot_quant_combobox->addItem (T("ms"), 1);
    iot_quant_combobox->addItem (T("128"), 2);
    iot_quant_combobox->addItem (T("128T"), 3);
    iot_quant_combobox->addItem (T("64"), 4);
    iot_quant_combobox->addItem (T("64T"), 5);
    iot_quant_combobox->addItem (T("32"), 6);
    iot_quant_combobox->addItem (T("32T"), 7);
    iot_quant_combobox->addItem (T("16"), 8);
    iot_quant_combobox->addItem (T("16T"), 9);
    iot_quant_combobox->addItem (T("8"), 10);
    iot_quant_combobox->addItem (T("8T"), 11);
    iot_quant_combobox->addItem (T("4"), 12);
    iot_quant_combobox->addItem (T("4T"), 13);
    ...
    delay_quant_combobox->setTextWhenNoChoicesAvailable (T("(no choices)"));
    delay_quant_combobox->addItem (T("ms"), 1);
    delay_quant_combobox->addItem (T("128"), 2);
    delay_quant_combobox->addItem (T("128T"), 3);
    delay_quant_combobox->addItem (T("64"), 4);
    delay_quant_combobox->addItem (T("64T"), 5);
    delay_quant_combobox->addItem (T("32"), 6);
    delay_quant_combobox->addItem (T("32T"), 7);
    delay_quant_combobox->addItem (T("16"), 8);
    delay_quant_combobox->addItem (T("16T"), 9);
    delay_quant_combobox->addItem (T("8"), 10);
    delay_quant_combobox->addItem (T("8T"), 11);
    delay_quant_combobox->addItem (T("4"), 12);
    delay_quant_combobox->addItem (T("4T"), 13);
    ...
    addAndMakeVisible (gliss_toggle = new ToggleButton (String::empty));
    gliss_toggle->addButtonListener (this);
    gliss_toggle->setToggleState (true, false);
    gliss_toggle->setColour (ToggleButton::textColourId, Colours::white);
    ...
    Plugin* const filter = getFilter();
    num_programs = filter->kNumPrograms;
    programNames = new String[num_programs];
    for(int i = 0; i < num_programs; i++) {
      //programNames[i] = new String;
      programNames[i] = "-";
...
PluginEditor::~PluginEditor()
{
    ...
    deleteAndZero (matrixMode1);
    deleteAndZero (matrixMode2);
    deleteAndZero (matrixMode3);
    deleteAndZero (scalekey_display);
    deleteAndZero (trans_toggle);
...
void PluginEditor::resized()
{
    ...
    label25->setBounds (524, 195, 124, 28);
    ...
    freeze_toggle->setBounds (152, 162, 24, 20);
    ...
    matrixMode1->setBounds (754, 72, 20, 20);
    matrixMode2->setBounds (754, 136, 20, 20);
    matrixMode3->setBounds (753, 201, 20, 20);
    scalekey_display->setBounds (612, 162, 31, 20);
    trans_toggle->setBounds (360, 120, 24, 20);
    ...
    gliss_toggle->setBounds (412, 120, 24, 20);
...
void PluginEditor::sliderValueChanged (Slider* sliderThatWasMoved)
{
  ...
  int index = 0;
    ...
    index = kGrains;
    value = value / filter->granulator->kMaxGrains;
    filter->setParameterNotifyingHost (index, value);
    ...
    if (index == kScaleKey) {
      scalekey_display->setText(filter->getParameterText(index));
    } else {
      param_display->setText(filter->getParameterText(index));
    }
    //[/UsersliderValueChanged_Post]
}
...
void PluginEditor::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
  ...
  int id = comboBoxThatHasChanged->getSelectedId();
    ...
    filter->setParameterNotifyingHost(kFtype, (id - 1) / 6.0f);
    ...
    if (program_combobox->getSelectedItemIndex() == -1) {
      ...
      name = name.trim();
      filter->changeProgramName(currentProgram, name);
    } else {
      changeProgram(id - 1);
    }
    //updateProgramNamesFromFilter();
    ...
    filter->parameters->setScale(id - 1);
    ...
    filter->parameters->setMatrixSource(0, id);
    ...
    filter->parameters->setMatrixDest(0, id);
    ...
    filter->parameters->setMatrixSource(1, id);
    ...
    filter->parameters->setMatrixDest(1, id);
    ...
    filter->parameters->setMatrixSource(2, id);
    ...
    filter->parameters->setMatrixDest(2, id);
    ...
    filter->setParameterNotifyingHost(kEnvType, envTypeValue);
    updateEnvSliders(id);
    ...
    else if (comboBoxThatHasChanged == dur_quant_combobox)
    {
      ...
      filter->setParameterNotifyingHost(kDurQuant, id / NumQuantModes::dur);
    ...
    else if (comboBoxThatHasChanged == iot_quant_combobox)
    {
      ...
      filter->setParameterNotifyingHost(kIotQuant, id / NumQuantModes::iot);
    ...
    else if (comboBoxThatHasChanged == delay_quant_combobox)
    {
      ...
      filter->setParameterNotifyingHost(kDelayQuant, id / NumQuantModes::delay);
...
void PluginEditor::buttonClicked (Button* buttonThatWasClicked)
{
  ...
  bool state;
    ...
    filter->saveProgramTo(currentProgram);
    ...
    if (result != 0) {
      filter->saveProgramTo(result - 1);
      filter->setCurrentProgram(result - 1);
    }
    ...
    else if (buttonThatWasClicked == freeze_toggle)
    {
        //[UserButtonCode_freeze_toggle] -- add your button handler code here..
    state = freeze_toggle->getToggleState();
    filter->setParameterNotifyingHost (kFreezeToggle, (float)state);
        //[/UserButtonCode_freeze_toggle]
    }
    else if (buttonThatWasClicked == matrixMode1)
    {
        //[UserButtonCode_matrixMode1] -- add your button handler code here..
    state = matrixMode1->getToggleState();
    filter->parameters->setMatrixMode(0, state);
    String text = state ? "Direct" : "Scaled";
    param_display->setText(text);
        //[/UserButtonCode_matrixMode1]
    }
    else if (buttonThatWasClicked == matrixMode2)
    {
        //[UserButtonCode_matrixMode2] -- add your button handler code here..
    state = matrixMode2->getToggleState();
    filter->parameters->setMatrixMode(1, state);
    String text = state ? "Direct" : "Scaled";
    param_display->setText(text);
        //[/UserButtonCode_matrixMode2]
    }
    else if (buttonThatWasClicked == matrixMode3)
    {
        //[UserButtonCode_matrixMode3] -- add your button handler code here..
    state = matrixMode3->getToggleState();
    filter->parameters->setMatrixMode(2, state);
    String text = state ? "Direct" : "Scaled";
    param_display->setText(text);
        //[/UserButtonCode_matrixMode3]
    }
    else if (buttonThatWasClicked == trans_toggle)
    {
        //[UserButtonCode_trans_toggle] -- add your button handler code here..
    state = trans_toggle->getToggleState();
    filter->setParameterNotifyingHost (kTransToggle, static_cast<float>(state));
    updateTransSliders(state);
        //[/UserButtonCode_trans_toggle]
    }
    else if (buttonThatWasClicked == gliss_toggle)
    {
        //[UserButtonCode_gliss_toggle] -- add your button handler code here..
      state = gliss_toggle->getToggleState();
      filter->setParameterNotifyingHost (kGlissToggle, static_cast<float>(state));
      updateGlissSliders(state);
        //[/UserButtonCode_gliss_toggle]
    }
...
void PluginEditor::changeProgram(int program)
{
  if (program != currentProgram) {
    getFilter()->setParameterNotifyingHost (kProgram, (float)(program)/ (num_programs - 1));
    updateParametersFromFilter();
  }
}

void PluginEditor::updateParametersFromFilter()
{
  Plugin* const filter = getFilter();
  filter->getCallbackLock().enter();

  bool state;
  currentProgram = filter->getCurrentProgram();

  program_combobox->setSelectedId(currentProgram + 1);
  mix_slider->setValue(filter->getParameter(kMix), false);
  ingain_slider->setValue(filter->getParameter(kIngain), false);
  amp_slider->setValue(filter->getParameter(kAmp), false);
  ampv_slider->setValue(filter->getParameter(kAmpv), false);
  pan_slider->setValue(filter->getParameter(kPan), false);
  panv_slider->setValue(filter->getParameter(kPanv), false);
  delay_slider->setValue(filter->getParameter(kDelay), false);
  delayv_slider->setValue(filter->getParameter(kDelayv), false);
  feedback_slider->setValue(filter->getParameter(kFeedback), false);
  gliss_slider->setValue(filter->getParameter(kGliss), false);
  glissv_slider->setValue(filter->getParameter(kGlissv), false);
  trans_slider->setValue(filter->getParameter(kTrans), false);
  transv_slider->setValue(filter->getParameter(kTransv), false);
  iot_slider->setValue(filter->getParameter(kIot), false);
  iotv_slider->setValue(filter->getParameter(kIotv), false);
  dur_slider->setValue(filter->getParameter(kDur), false);
  durv_slider->setValue(filter->getParameter(kDurv), false);
  ffreq_slider->setValue(filter->getParameter(kFfreq), false);
  ffreqv_slider->setValue(filter->getParameter(kFfreqv), false);
  fq_slider->setValue(filter->getParameter(kFq), false);
  fqv_slider->setValue(filter->getParameter(kFqv), false);
  grains_slider->setValue(filter->getParameter(kGrains) * filter->granulator->kMaxGrains, false);
  envshape_slider->setValue(filter->getParameter(kEnvSustain), false);
  envskew_slider->setValue(filter->getParameter(kEnvSkew), false);
  scalekey_slider->setValue(filter->getParameter(kScaleKey) * 12, false);
  scalekey_display->setText(filter->getParameterText(kScaleKey));

  // Scale
  if (scale_combobox->getNumItems() == 0) {
    std::vector<String> names = filter->getScaleNames();
    scale_combobox->addItem("unquantized", 1);
    for(int i = 0; i < (int)names.size(); i++)
      scale_combobox->addItem(names.at(i), (i + 2));
  }
  int id = filter->parameters->getScale();
  scale_combobox->setSelectedId(id + 1);

  // Glissando
  state = (filter->getParameter(kGlissToggle) == 0.0f) ? false : true;
  updateGlissSliders(state);

  // Filter
  float f = filter->getParameter(kFtype) * 6.0f + 1.0f;
  ...
  // Envelope
  float envT = filter->getParameter(kEnvType) * 2.0f + 1.0f;
  ...
  matrix_mod_slider_1->setValue(
      (filter->getParameter(kMatrixMod1) - 0.5f) * 200.0f, false);
  matrix_mod_slider_2->setValue(
      (filter->getParameter(kMatrixMod2) - 0.5f) * 200.0f, false);
  matrix_mod_slider_3->setValue(
      (filter->getParameter(kMatrixMod3) - 0.5f) * 200.0f, false);
  matrix_src_combobox_1->setSelectedId(filter->parameters->getMatrixSource(0));
  matrix_src_combobox_2->setSelectedId(filter->parameters->getMatrixSource(1));
  matrix_src_combobox_3->setSelectedId(filter->parameters->getMatrixSource(2));
  matrix_dest_combobox_1->setSelectedId(filter->parameters->getMatrixDest(0));
  matrix_dest_combobox_2->setSelectedId(filter->parameters->getMatrixDest(1));
  matrix_dest_combobox_3->setSelectedId(filter->parameters->getMatrixDest(2));

  state = (filter->parameters->getMatrixMode(0) == 0) ? false : true;
  matrixMode1->setToggleState(state, false);
  state = (filter->parameters->getMatrixMode(1) == 0) ? false : true;
  matrixMode2->setToggleState(state, false);
  state = (filter->parameters->getMatrixMode(2) == 0) ? false : true;
  matrixMode3->setToggleState(state, false);

  // trans toggle
  state = (filter->getParameter(kTransToggle) == 0.0f)? false : true;
  trans_toggle->setToggleState(state, false);
  updateTransSliders(state);

  // gliss toggle
  state = (filter->getParameter(kGlissToggle) == 0.0f)? false : true;
  gliss_toggle->setToggleState(state, false);
  updateGlissSliders(state);

  // freeze toggle
  state = (filter->getParameter(kFreezeToggle) == 0.0f)? false : true;
  freeze_toggle->setToggleState(state, false);

  // time quantization
  id = MathFunc::roundFtoI(filter->getParameter(kDelayQuant) * NumQuantModes::delay);
  if(id == 0) id++;
  delay_quant_combobox->setSelectedId(id);
  id = MathFunc::roundFtoI(filter->getParameter(kIotQuant) * NumQuantModes::iot);
  if(id == 0) id++;
  iot_quant_combobox->setSelectedId(id);
  id = MathFunc::roundFtoI(filter->getParameter(kDurQuant) * NumQuantModes::dur);
  if(id == 0) id++;
...
void PluginEditor::updateScaleComponents(bool state)
{
  ...
  if (state) {
    scalekey_display->setText(getFilter()->getParameterText(kScaleKey));
  } else {
    scalekey_display->setText("");
  }
}

void PluginEditor::updateProgramNamesFromFilter()
{
  Plugin* const filter = getFilter();
  int currentProgram = filter->getCurrentProgram();
  bool editorSaved = filter->getEditorSavedState();

  for(int i = 0; i < num_programs; i++) {
    programNames[i] = filter->getProgramName(i);
    if (i == currentProgram) {
      if (editorSaved) {
        program_combobox->changeItemText(i+1,
                                        String(i+1)
                                        + String(": ")
                                        + String(programNames[i]));
      } else {
        program_combobox->changeItemText(i+1,
                                        String ("*")
                                        + String(i+1)
...
<JUCER_COMPONENT documentType="Component" className="PluginEditor" componentName=""
                 ...
                 constructorParams="Plugin* const ownerFilter" variableInitialisers="AudioProcessorEditor(ownerFilter)"
                 snapPixels="2" snapActive="1" snapShown="0" overlayOpacity="0.330000013"
                 fixedSize="0" initialWidth="780" initialHeight="225">
  ...
  <TEXTBUTTON name="" id="d6d7d2b2f698d013" memberName="initButton" virtualName=""
              ...
              buttonText="Init" connectedEdges="7" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="5e33e2e22aa3407a" memberName="saveButton" virtualName=""
              ...
              buttonText="Save" connectedEdges="7" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="ab276ca6001ba75b" memberName="savetoButton" virtualName=""
              ...
              buttonText="Save To" connectedEdges="7" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="" id="22e30bf7dd9d0470" memberName="decPresetButton" virtualName=""
              ...
              buttonText="-" connectedEdges="7" needsCallback="1" radioGroupId="0"/>
  ...
  <LABEL name="" id="780e32317de9f68c" memberName="label25" virtualName=""
         explicitFocusOrder="0" pos="524 195 124 28" tooltip=""
         textCol="ffffffff" edTextCol="ff000000" edBkgCol="0" labelText="argotlunar v2.0.2"
  ...
  <SLIDER name="" id="5e036513674e016f" memberName="envskew_slider" virtualName=""
          ...
          rotarysliderfill="fbffffff" rotaryslideroutline="ff3c3c54" min="0.05"
          max="0.95" int="0.001" style="RotaryVerticalDrag" textBoxPos="NoTextBox"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  ...
  <LABEL name="" id="2e49de53ba454796" memberName="label28" virtualName=""
         ...
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default sans-serif font"
         fontsize="14" bold="0" italic="0" justification="36"/>
  <TOGGLEBUTTON name="" id="2743925fd6ee5087" memberName="freeze_toggle" virtualName=""
                explicitFocusOrder="0" pos="152 162 24 20" txtcol="ffffffff"
  ...
  <LABEL name="" id="bbd9e85cb7b671b7" memberName="label37" virtualName=""
         ...
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default sans-serif font"
         fontsize="14" bold="0" italic="0" justification="36"/>
  <TOGGLEBUTTON name="" id="ebc700df29bbbed7" memberName="matrixMode1" virtualName=""
                explicitFocusOrder="0" pos="754 72 20 20" txtcol="ffffffff" buttonText=""
                connectedEdges="0" needsCallback="1" radioGroupId="0" state="1"/>
  <TOGGLEBUTTON name="" id="ea8cea353adc7a91" memberName="matrixMode2" virtualName=""
                explicitFocusOrder="0" pos="754 136 20 20" txtcol="ffffffff"
                buttonText="" connectedEdges="0" needsCallback="1" radioGroupId="0"
                state="1"/>
  <TOGGLEBUTTON name="" id="45253df97b33e93" memberName="matrixMode3" virtualName=""
                explicitFocusOrder="0" pos="753 201 20 20" txtcol="ffffffff"
                buttonText="" connectedEdges="0" needsCallback="1" radioGroupId="0"
                state="1"/>
  ...
  <TOGGLEBUTTON name="" id="206c3d6b3bf9ef70" memberName="trans_toggle" virtualName=""
                explicitFocusOrder="0" pos="360 120 24 20" txtcol="ffffffff"
                buttonText="" connectedEdges="0" needsCallback="1" radioGroupId="0"
                state="1"/>
  ...
  <LABEL name="" id="4e10540f2ba9b25a" memberName="label32" virtualName=""
         ...
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default sans-serif font"
         fontsize="14" bold="0" italic="0" justification="36"/>
  <TOGGLEBUTTON name="" id="69f020d8ac12ab42" memberName="gliss_toggle" virtualName=""
                explicitFocusOrder="0" pos="412 120 24 20" txtcol="ffffffff"
                buttonText="" connectedEdges="0" needsCallback="1" radioGroupId="0"
                state="1"/>
</JUCER_COMPONENT>
