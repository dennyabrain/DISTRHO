...
void PluginEditor::saveBankFile(Plugin* const plugin)
{
    ...
    if (myChooser.browseForFileToSave(true)) {
        ...
        if (file.getFileExtension() != ".bank") {
           plugin->saveBankXml(&(file.withFileExtension(".bank")));
        }
        else {
...
void PluginEditor::saveProgramFile(Plugin* const plugin)
{
    ...
    if (myChooser.browseForFileToSave(true)) {
        ...
        if (file.getFileExtension() != ".program") {
            plugin->saveCurrentProgramXml(&(file.withFileExtension(".program")));
        }
        else {
...
void PluginEditor::updateParametersFromPlugin()
{
    ...
    mix_slider->setValue(plugin->getParameter(kMix), false);
    ingain_slider->setValue(plugin->getParameter(kIngain), false);
    amp_slider->setValue(plugin->getParameter(kAmp), false);
    ampv_slider->setValue(plugin->getParameter(kAmpv), false);
    pan_slider->setValue(plugin->getParameter(kPan), false);
    panv_slider->setValue(plugin->getParameter(kPanv), false);
    delay_slider->setValue(plugin->getParameter(kDelay), false);
    delayv_slider->setValue(plugin->getParameter(kDelayv), false);
    feedback_slider->setValue(plugin->getParameter(kFeedback), false);
    gliss_slider->setValue(plugin->getParameter(kGliss), false);
    glissv_slider->setValue(plugin->getParameter(kGlissv), false);
    trans_slider->setValue(plugin->getParameter(kTrans), false);
    transv_slider->setValue(plugin->getParameter(kTransv), false);
    iot_slider->setValue(plugin->getParameter(kIot), false);
    iotv_slider->setValue(plugin->getParameter(kIotv), false);
    dur_slider->setValue(plugin->getParameter(kDur), false);
    durv_slider->setValue(plugin->getParameter(kDurv), false);
    ffreq_slider->setValue(plugin->getParameter(kFfreq), false);
    ffreqv_slider->setValue(plugin->getParameter(kFfreqv), false);
    fq_slider->setValue(plugin->getParameter(kFq), false);
    fqv_slider->setValue(plugin->getParameter(kFqv), false);
    grains_slider->setValue(plugin->getParameter(kGrains) * plugin->granulator->kMaxGrains, false);
    envshape_slider->setValue(plugin->getParameter(kEnvSustain), false);
    envskew_slider->setValue(plugin->getParameter(kEnvSkew), false);
    scalekey_slider->setValue(plugin->getParameter(kScaleKey) * 12, false);
    ...
    matrix_mod_slider_1->setValue(
        (plugin->getParameter(kMatrixMod1) - 0.5f) * 200.0f, false);
    matrix_mod_slider_2->setValue(
        (plugin->getParameter(kMatrixMod2) - 0.5f) * 200.0f, false);
    matrix_mod_slider_3->setValue(
        (plugin->getParameter(kMatrixMod3) - 0.5f) * 200.0f, false);
...
<JUCER_COMPONENT documentType="Component" className="PluginEditor" componentName=""
  ...
  <LABEL name="" id="780e32317de9f68c" memberName="label25" virtualName=""
         ...
         edTextCol="ff000000" edBkgCol="0" labelText="Argotlunar v2.0.5"
