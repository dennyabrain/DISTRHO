...
ifeq ($(CONFIG),Release)
  ...
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -fPIC -O3 `pkg-config --cflags freetype2` -O2 -mtune=generic -msse -fpermissive -ffast-math -fomit-frame-pointer -fvisibility=hidden -fPIC
  CXXFLAGS += $(CFLAGS)
...
ifeq ($(CONFIG),Debug)
  ...
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -fPIC -g `pkg-config --cflags freetype2` -O0 -ggdb -fpermissive -fPIC
  CXXFLAGS += $(CFLAGS)
