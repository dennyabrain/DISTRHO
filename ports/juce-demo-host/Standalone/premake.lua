...
package.defines    = { "JUCE_PLUGINHOST_VST=1", "JUCE_PLUGINHOST_AU=1" };
...
package.config["Release"].links        = { "juce-standalone-vst-153" }

package.config["Debug"].target         = project.name .. "_debug"
package.config["Debug"].objdir         = "intermediate/Debug"
package.config["Debug"].defines        = { "DEBUG=1", "_DEBUG=1" };
package.config["Debug"].links          = { "juce-standalone-vst-153_debug" }
