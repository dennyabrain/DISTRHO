...
project.name    = "drumsynth.lv2/DrumSynth"
...
package.defines   = { "JucePlugin_Build_AU=0", "JucePlugin_Build_LV2=1", "JucePlugin_Build_RTAS=0", "JucePlugin_Build_VST=0", "JucePlugin_Build_Standalone=0", "USE_JUCED=1" }
...
package.config["Release"].links        = { "juce", "juced" }
...
package.config["Debug"].links          = { "juce_debug", "juced_debug" }
