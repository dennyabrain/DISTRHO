...
ifeq ($(CONFIG),Release)
  ...
  OUTDIR := ../../../bin/
  CPPFLAGS := $(DEPFLAGS) -D "LINUX=1" -D "NDEBUG=1" -D "JUCE_ALSA=0" -D "JUCE_USE_VSTSDK_2_4=1" -I "../src" -I "../src/engine" -I "../src/engine/synth" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-152/source" -I "../../../sdks/vstsdk2.4" -I "."
  ...
  LDDEPS :=
  RESFLAGS := -D "LINUX=1" -D "NDEBUG=1" -D "JUCE_ALSA=0" -D "JUCE_USE_VSTSDK_2_4=1" -I "../src" -I "../src/engine" -I "../src/engine/synth" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-152/source" -I "../../../sdks/vstsdk2.4" -I "."
...
ifeq ($(CONFIG),Debug)
  ...
  OUTDIR := ../../../bin/
  CPPFLAGS := $(DEPFLAGS) -D "LINUX=1" -D "DEBUG=1" -D "_DEBUG=1" -D "JUCE_ALSA=0" -D "JUCE_USE_VSTSDK_2_4=1" -I "../src" -I "../src/engine" -I "../src/engine/synth" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-152/source" -I "../../../sdks/vstsdk2.4" -I "."
  ...
  LDDEPS :=
  RESFLAGS := -D "LINUX=1" -D "DEBUG=1" -D "_DEBUG=1" -D "JUCE_ALSA=0" -D "JUCE_USE_VSTSDK_2_4=1" -I "../src" -I "../src/engine" -I "../src/engine/synth" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-152/source" -I "../../../sdks/vstsdk2.4" -I "."
