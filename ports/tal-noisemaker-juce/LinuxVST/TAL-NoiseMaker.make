...
ifeq ($(CONFIG),Release)
  ...
  OUTDIR := ../../../bin/
  CPPFLAGS := $(DEPFLAGS) -D "LINUX=1" -D "NDEBUG=1" -D "JUCE_USE_VSTSDK_2_4=1" -I "../src" -I "../src/Engine" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-153/source" -I "../../../sdks/vstsdk2.4" -I "." -I "./intermediate" -I "./intermediate/Release"
  ...
  LDDEPS :=
  RESFLAGS := -D "LINUX=1" -D "NDEBUG=1" -D "JUCE_USE_VSTSDK_2_4=1" -I "../src" -I "../src/Engine" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-153/source" -I "../../../sdks/vstsdk2.4" -I "." -I "./intermediate" -I "./intermediate/Release"
...
ifeq ($(CONFIG),Debug)
  ...
  OUTDIR := ../../../bin/
  CPPFLAGS := $(DEPFLAGS) -D "LINUX=1" -D "DEBUG=1" -D "_DEBUG=1" -D "JUCE_USE_VSTSDK_2_4=1" -I "../src" -I "../src/Engine" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-153/source" -I "../../../sdks/vstsdk2.4" -I "." -I "./intermediate" -I "./intermediate/Release"
  ...
  LDDEPS :=
  RESFLAGS := -D "LINUX=1" -D "DEBUG=1" -D "_DEBUG=1" -D "JUCE_USE_VSTSDK_2_4=1" -I "../src" -I "../src/Engine" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-153/source" -I "../../../sdks/vstsdk2.4" -I "." -I "./intermediate" -I "./intermediate/Release"
