...
void KlangFalterEditor::updateUI()
{
  ...
  }
  {
    ...
    _beginLabel->setText(juce::String(static_cast<int>(fileBeginSeconds*1000.0 + 0.5)) + juce::String("ms"), sendNotificationSync);
  }
  {
    ...
    _predelayLabel->setText(juce::String(static_cast<int>(predelayMs+0.5)) + juce::String("ms"), sendNotificationSync);
  }
  {
  ...
  }
  {
    ...
    _widthLabel->setText(juce::String(stereoWidth, 2), dontSendNotification);
  }
  {
