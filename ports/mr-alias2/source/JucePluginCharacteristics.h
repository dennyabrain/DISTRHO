...
/** Magic switch that disables the GUI (or put "noGUI" in the plugin's filename)
*/
//#define PIZ_NO_GUI

/** Enables "fx" or "nofx" switches in filename
*/
...
*/
  ...
  #define JucePlugin_Name					  "Mr. Alias 2"
#else
  #define JucePlugin_Name                     "Mr. Alias 2 fx"
#endif

#ifdef MRALIASPRO
  #undef  JucePlugin_Name
  #if JucePlugin_IsSynth
    #define JucePlugin_Name					  "Mr. Alias Pro"
  #else
    #define JucePlugin_Name                   "Mr. Alias Pro fx"
  #endif
#endif

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "High-Alias Synth"
...
*/
#ifdef MRALIASPRO
#define Piz_InstID                            'MrAP'
#define Piz_EffectID                          'MrPx'
#else
#define Piz_InstID                            'MrA2'
#define Piz_EffectID                          'MrAx'
#endif
#if JucePlugin_IsSynth
...
/** A version number
*/
#define JucePlugin_VersionCode              0x00020400  
...
#ifdef MRALIASPRO
  #if JucePlugin_IsSynth
    #define JucePlugin_AUExportPrefix     MrAliasProAU
  #else
    #define JucePlugin_AUExportPrefix     MrAliasProAUfx  
  #endif
#else
  #if JucePlugin_IsSynth
    #define JucePlugin_AUExportPrefix     MrAlias2AU
  #else
    #define JucePlugin_AUExportPrefix     MrAlias2AUfx  
  #endif
#endif
...
#ifdef MRALIASPRO
  #if JucePlugin_IsSynth
    #define JucePlugin_AUExportPrefixQuoted     "MrAliasProAU"
  #else
    #define JucePlugin_AUExportPrefixQuoted     "MrAliasProAUfx"  
  #endif
#else
  #if JucePlugin_IsSynth
    #define JucePlugin_AUExportPrefixQuoted     "MrAlias2AU"
  #else
    #define JucePlugin_AUExportPrefixQuoted     "MrAlias2AUfx"  
  #endif
#endif
...
*/
#ifdef MRALIASPRO
#define JucePlugin_CFBundleIdentifier       "org.thepiz.MrAliasPro"
#else
#define JucePlugin_CFBundleIdentifier       "org.thepiz.MrAlias2"
#endif
