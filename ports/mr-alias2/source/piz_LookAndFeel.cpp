                                    ...
                                    Slider& slider)
{
    ...
    Path m;
    m.addLineSegment (0.0f, 0.0f, 0.0f, -radius, rw * 0.2f);
    ...
    font.setTypefaceName("small fonts");
    g.setFont(slider.getHeight()*0.4f,Font::bold);
...
void PizLookAndFeel::drawTooltip (Graphics& g, const String& text, int width, int height)
{
    ...
    tl.drawWithin (g, Rectangle<float>(0, 0, width, height), Justification::centred, 0);
}
