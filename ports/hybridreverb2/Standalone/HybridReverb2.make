...
ifeq ($(CONFIG),Release)
  ...
  OUTDIR := ../../../bin
  CPPFLAGS := $(DEPFLAGS) -D "JucePlugin_Build_AU=0" -D "JucePlugin_Build_LV2=0" -D "JucePlugin_Build_RTAS=0" -D "JucePlugin_Build_VST=0" -D "JucePlugin_Build_Standalone=1" -D "LINUX=1" -D "NDEBUG=1" -I "../source" -I "../../../libs/juce-2.0/source" -I "../../../libs/juce-plugin"
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -O3 `pkg-config --cflags freetype2 fftw3f` -O2 -mtune=generic -msse -ffast-math -fomit-frame-pointer -funroll-loops -fopenmp -fvisibility=hidden -fPIC
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -s `pkg-config --libs freetype2 fftw3f` -L"../../../libs" -lfreetype -lpthread -lasound -ldl -lrt -lX11 -lXext -lgomp -ljuce-core -ljuce-audio-basics -ljuce-audio-devices_full -ljuce-audio-formats -ljuce-audio-processors -ljuce-audio-utils -ljuce-data-structures -ljuce-events -ljuce-graphics -ljuce-gui-basics
  LDDEPS :=
  RESFLAGS := -D "JucePlugin_Build_AU=0" -D "JucePlugin_Build_LV2=0" -D "JucePlugin_Build_RTAS=0" -D "JucePlugin_Build_VST=0" -D "JucePlugin_Build_Standalone=1" -D "LINUX=1" -D "NDEBUG=1" -I "../source" -I "../../../libs/juce-2.0/source" -I "../../../libs/juce-plugin"
...
ifeq ($(CONFIG),Debug)
  ...
  OUTDIR := ../../../bin
  CPPFLAGS := $(DEPFLAGS) -D "JucePlugin_Build_AU=0" -D "JucePlugin_Build_LV2=0" -D "JucePlugin_Build_RTAS=0" -D "JucePlugin_Build_VST=0" -D "JucePlugin_Build_Standalone=1" -D "LINUX=1" -D "DEBUG=1" -D "_DEBUG=1" -I "../source" -I "../../../libs/juce-2.0/source" -I "../../../libs/juce-plugin"
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -g `pkg-config --cflags freetype2 fftw3f` -O0 -ggdb -msse -fPIC
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) `pkg-config --libs freetype2 fftw3f` -L"../../../libs" -lfreetype -lpthread -lasound -ldl -lrt -lX11 -lXext -lgomp -ljuce-core_debug -ljuce-audio-basics_debug -ljuce-audio-devices_full_debug -ljuce-audio-formats_debug -ljuce-audio-processors_debug -ljuce-audio-utils_debug -ljuce-data-structures_debug -ljuce-events_debug -ljuce-graphics_debug -ljuce-gui-basics_debug
  LDDEPS :=
  RESFLAGS := -D "JucePlugin_Build_AU=0" -D "JucePlugin_Build_LV2=0" -D "JucePlugin_Build_RTAS=0" -D "JucePlugin_Build_VST=0" -D "JucePlugin_Build_Standalone=1" -D "LINUX=1" -D "DEBUG=1" -D "_DEBUG=1" -I "../source" -I "../../../libs/juce-2.0/source" -I "../../../libs/juce-plugin"
