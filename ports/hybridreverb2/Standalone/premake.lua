...
package.linkoptions = { "`pkg-config fftw3f --libs`" }
...
package.config["Release"].buildoptions = { "-O2 -mtune=generic -msse -ffast-math -fomit-frame-pointer -funroll-loops -fopenmp -fvisibility=hidden -fPIC `pkg-config fftw3f --cflags`" }
...
package.config["Debug"].buildoptions   = { "-O0 -ggdb -msse -fPIC `pkg-config fftw3f --cflags`" }
