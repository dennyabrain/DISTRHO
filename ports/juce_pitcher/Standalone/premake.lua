...
package.config["Release"].links        = { "freetype", "pthread", "asound", "dl", "m", "rt", "X11", "Xext", "juce-standalone-153" }

package.config["Debug"].target         = project.name .. "_debug"
package.config["Debug"].objdir         = "intermediate/Debug"
package.config["Debug"].buildoptions   = { "-O0 -ggdb -static" }
package.config["Debug"].links          = { "freetype", "pthread", "asound", "dl", "m", "rt", "X11", "Xext", "juce-standalone-153_debug" }
