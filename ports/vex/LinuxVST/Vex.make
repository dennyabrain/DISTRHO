...
ifeq ($(CONFIG),Release)
  ...
  OUTDIR := ../../../bin/
  CPPFLAGS := $(DEPFLAGS) -D "LINUX=1" -D "NDEBUG=1" -D "JUCE_ALSA=0" -D "JUCE_USE_VSTSDK_2_4=1" -D "XVEX_VST_PLUGIN=1" -I "../src" -I "../src/soundtouch" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-153/source" -I "../../../libs/juce-153/source/extras/audio plugins" -I "../../../sdks/vstsdk2.4"
  ...
  LDDEPS :=
  RESFLAGS := -D "LINUX=1" -D "NDEBUG=1" -D "JUCE_ALSA=0" -D "JUCE_USE_VSTSDK_2_4=1" -D "XVEX_VST_PLUGIN=1" -I "../src" -I "../src/soundtouch" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-153/source" -I "../../../libs/juce-153/source/extras/audio plugins" -I "../../../sdks/vstsdk2.4"
  TARGET := libVex.so
...
ifeq ($(CONFIG),Debug)
  ...
  OUTDIR := ../../../bin/
  CPPFLAGS := $(DEPFLAGS) -D "LINUX=1" -D "DEBUG=1" -D "_DEBUG=1" -D "JUCE_ALSA=0" -D "JUCE_USE_VSTSDK_2_4=1" -D "XVEX_VST_PLUGIN=1" -I "../src" -I "../src/soundtouch" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-153/source" -I "../../../libs/juce-153/source/extras/audio plugins" -I "../../../sdks/vstsdk2.4"
  ...
  LDDEPS :=
  RESFLAGS := -D "LINUX=1" -D "DEBUG=1" -D "_DEBUG=1" -D "JUCE_ALSA=0" -D "JUCE_USE_VSTSDK_2_4=1" -D "XVEX_VST_PLUGIN=1" -I "../src" -I "../src/soundtouch" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../libs/juce-153/source" -I "../../../libs/juce-153/source/extras/audio plugins" -I "../../../sdks/vstsdk2.4"
